      ...
      <div className="grid gap-8 lg:grid-cols-2">
        ...
        <div className="space-y-6">
          <div>
            ...
            <a href="mailto:info@yourdomain.com" className="text-[var(--color-primary)] hover:underline">
              info@yourdomain.com
            </a>
          </div>
          <div>
            <h3 className="mb-2 font-semibold">{t("phone")}</h3>
            <a href="tel:+8613800138000" className="text-[var(--color-primary)] hover:underline">
              +86 138-0013-8000
            </a>
          </div>
          <div>
